            ...
            <div className="app__container">
                <div className="game">
                    <div className="game__player">
                        ...
                        <div
                            className={`image image__${playerChoice} ${playerWin == "win" ? `image image__${playerChoice}__winner` : ""
                                }`}
                        ></div>
                    </div>
                    {playerWin == "win" && (
                    ...
                    <div className="game__com">
                        ...
                        {counter == 0 ? (
                            <div
                                className={`image image__${com} ${playerWin == "lose" ? `image image__${com}__winner` : ""
                                    }`}
                            ></div>
                        ) : (
